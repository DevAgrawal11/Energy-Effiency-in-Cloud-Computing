...
if __name__ == "__main__":
    # Set Energy limit if not defined in systemComfig
    Energy_limit = 300
    
    # Get the arrays from generate_table()
    BW_arr, Energy_arr = generate_table()
    
    # Build the DP table
    result = build_dp_table(Energy_arr, BW_arr, Energy_limit)
    
    # Print results
    print("Dynamic Programming Table Results:")
